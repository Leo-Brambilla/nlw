...
export function NewHabitForm() {
    ...
    function handleTogggleWeekDay(weekDay: number) {
    ...
    return (
        <form onSubmit={createNewHabit} className="w-full flex flex-col mt-6 max-h-screen overflow-y-auto">
                ...
                {availableWeekDays.map((weekDay, index) => {
                    return (
                        <Checkbox.Root
                            ...
                            onCheckedChange={() => handleTogggleWeekDay(index)}
                        >
